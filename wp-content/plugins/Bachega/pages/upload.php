...
<div class="row text-center">
    ...
    <div class="col-4 bgbox">
        ...
        for ($bI = 0; $bI < count($resultFiels); $bI++) echo '<div draggable="true" class="box-fields lessthan" data-side="left" data-column="' . $resultFiels[$bI]['name'] . '" data-table="bd_meta_peoples" >' . $resultFiels[$bI]['name'] . '</div>';
