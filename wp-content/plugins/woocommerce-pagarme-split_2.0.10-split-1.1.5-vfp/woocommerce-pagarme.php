<?php
/**
 * Plugin Name: WooCommerce Pagar.me com split de recebedor
 * Plugin URI: http://github.com/claudiosmweb/woocommerce-pagarme
 * Description: Gateway de pagamento Pagar.me para WooCommerce. Com suporte a split de recebedores.
 * Author: Barradev(Rui Andrada)
 * Author URI: https://barradev.com/
 * Version: 2.0.10-split-1.1.5
	...
	class WC_Pagarme {
		...
		private function __construct() {
			...
			if ( ! class_exists( 'YITH_Vendors' ) ) {
				add_action( 'admin_notices', array( $this, 'yith_woocommerce_multivendors_missing_notice' ) );
			}
		}
		...
		private function includes() {
			...
			include_once dirname( __FILE__ ) . '/includes/init-integrations.php';
		}
		...
		/**
		 * YITH WooCommerce Multi Vendors fallback notice.
		 */
		public function yith_woocommerce_multivendors_missing_notice() {
			include dirname( __FILE__ ) . '/includes/admin/views/html-notice-missing-multivendors.php';
		}
