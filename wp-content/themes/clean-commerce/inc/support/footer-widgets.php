 ...
 * @since 1.0.0
 */
class Clean_Commerce_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'clean_commerce';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'clean-commerce' ), $i ),
...
// Initialize.
$clean_commerce_footer_widgets = new Clean_Commerce_Footer_Widgets();
